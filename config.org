...
;; FONT
(setq doom-font                (font-spec :family "Source Code Pro Medium" :size 13 :weight 'regular))
(setq doom-variable-pitch-font (font-spec :family "Arial" :weight 'regular   :size 13))
