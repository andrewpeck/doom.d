;;; monochrome-solarized-theme.el --- A dark Emacs 24 theme for your focused hacking sessions
...
;;
;;     M-x load-theme RET monochrome-solarized RET
;;
;; or put in your init file
;;
;;     (load-theme 'monochrome-solarized)
;;
...
(provide-theme 'monochrome-solarized)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; monochrome-solarized-theme.el ends here
