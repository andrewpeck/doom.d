...
;; ---------------------------
;;
;; Summerfruit: A light color theme
;;
;; ----------------------------
...
(deftheme summerfruit "A dark color theme for Emacs")

(let ((*background*         "#ffffff") ;; white

      (*comments*           "#22a21f") ;; green
      (*constant*           "#ff0086") ;; pink
      (*current-line*       "#EEE")
      (*line-number*        "#0086f7")
      (*cursor-underscore*  "#0e1f5b")
      (*keywords*           "#fb660a") ;; orange
