...
(let* ((white "#FFFFFF")
  ...
  (custom-theme-set-faces
   ...
   `(org-table ,default-layer)

   ;; Flycheck
   `(flycheck-error   ((t (:underline (:color ,light-red   :style wave)))))
   `(flycheck-info    ((t (:underline (:color ,light-green :style wave)))))
   `(flycheck-warning ((t (:underline (:color ,barely-orange :style wave)))))
   ...
   `(mode-line ((t (:background ,light-green))))
   `(minibuffer-prompt ((t (:foreground ,blue))))

   ;; Basic font lock entries
   `(font-lock-warning-face ,default-layer)
   `(font-lock-function-name-face ,definition-layer)
   `(font-lock-keyword-face ,definition-layer)
   `(font-lock-builtin-face ,definition-layer)
   `(font-lock-type-face ,definition-layer)
   ...
   `(diff-refine-added ((t (:background ,almost-light-green))))
   `(diff-refine-changed ((t (:background ,lighter-orange))))
   `(diff-hl-delete ,reder-light-red-layer)
   `(diff-hl-insert ((t (:background ,dark-green))))
   ...
   `(tree-sitter-hl-face:property ((t (:foreground ,dark-blue))))
   `(tree-sitter-hl-face:method.call ,definition-layer)
   ...
   `(diredfl-dir-name ((t (:weight bold :foreground ,black))))
   `(diredfl-dir-heading ((t (:weight bold :foreground ,black))))
   `(diredfl-dir-priv ,default-layer)
   `(diredfl-read-priv ,default-layer)
   `(diredfl-write-priv ,default-layer)
   `(diredfl-exec-priv ,default-layer)
   `(diredfl-no-priv ,default-layer)
   `(diredfl-number ,definition-layer)
   `(diredfl-date-time ,commentary-layer)
