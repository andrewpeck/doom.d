...
(let ((class '((class color) (min-colors 89)))
      ...
      ; Org mode levels
      (ol1 '(:height 1.5 :weight bold :slant normal :foreground "#ea6300" :extend t))
      (ol2 '(:height 1.3 :weight bold :slant normal :foreground "#336699" :extend t))
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-constant-face ((,class (:foreground "#ff0086"))))
   ...
   `(font-lock-function-name-face ((,class (:foreground "#ff0086"))))
   ...
   `(vhdl-font-lock-attribute-face ((,class (:foreground "#ff0086"))))
