...
;; start:sort
(package! backup-each-save        :recipe (:host github :repo "andrewpeck/backup-each-save"))
(package! bookmark-url.el         :recipe (:host github :repo "andrewpeck/bookmark-url.el"))
(package! buffer-flip.el          :recipe (:host github :repo "andrewpeck/buffer-flip.el"))
(package! cloc.el                 :recipe (:host github :repo "andrewpeck/cloc.el"))
(package! emacs-ucf-mode          :recipe (:host github :repo "andrewpeck/emacs-ucf-mode"))
(package! hdldep                  :recipe (:host github :repo "andrewpeck/hdldep.el"))
(package! hog                     :recipe (:host github :repo "andrewpeck/hog.el"))
(package! ob-wavedrom             :recipe (:host github :repo "andrewpeck/ob-wavedrom"))
(package! org-excalidraw          :recipe (:host github :repo "andrewpeck/org-excalidraw") )
(package! python-string-toggle.el :recipe (:host github :repo "andrewpeck/python-string-toggle.el"))
(package! resume                  :recipe (:host github :repo "andrewpeck/resume.el"))
(package! system-install          :recipe (:host github :repo "andrewpeck/system-install.el"))
(package! timesheet               :recipe (:host github :repo "andrewpeck/timesheet.el"))
(package! verilog-port-copy       :recipe (:host github :repo "andrewpeck/verilog-port-copy"))
(package! vivado_mode             :recipe (:host github :repo "andrewpeck/vivado_mode"))
;; end:sort
...
(package! apheleia                :pin "011e7b999552f3c0730035183a4a6dfb60c10182")
