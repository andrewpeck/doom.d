 ...
 '(safe-local-variable-values
   '((eval progn
     ...
     (eval add-hook 'after-save-hook
      (lambda nil
        (progn
          (start-process "update-slaves" nil "python" "update_control.py")
          (revert-buffer)))
      nil 'local)
     (eval add-hook 'after-save-hook
      (lambda nil
        (org-sbe "export-block"))
      nil 'local)
     (eval add-hook 'after-save-hook
      (lambda nil
