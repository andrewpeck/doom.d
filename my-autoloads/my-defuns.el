;; -*- lexical-binding: t; -*-
;;
;; This file should have autoloaded functions which are rarely used. Since they
;; are autoloaded, calling any of these functions will prompt loading of ALL
;; functions, so keep out anything that is required early after init.
;;
